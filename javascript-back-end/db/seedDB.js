...
db.lessons.insert({
  ...
  answers: ['const ship = ["Blackbeard", "Scurvy Legs", "Billy Bones"]', 'ship.push("Captain Jack")', "ship.push(' Pirate Joe')", "p ship"], story: "After successfully finding gold coins on OopyLoopy Island Captain Jack and Pirate Joe make their way back to the ship to add their gold to the pirate treasure chest.", result: '[Blackbeard", "Scurvy Legs", "Billy Bones", "Captain Jack", "Pirate Joe"]'});
