  ...
  <div className="home">
    ...
    <div className="orderBoxes">
      <div className="textBox1">
        <h3>
Captain Jack's App provides engaging, educational fun.
        You won't have to entertain them if they're coding in JavaScript..
        </h3>
      </div>
      <div className="textBox2">
        <h3>
Coding is good for kids yay. Need your computer fixed?
         Wouldn't it be so much cheaper if your kids knew how to fix it?
          {' '}
        </h3>
      </div>
    </div>
