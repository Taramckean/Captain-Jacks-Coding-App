...
const Lessons = () => {
  return(
    ...
    <div className="lesson-list">
      ...
      <h4 className="lessonText">Oh no! That dastardly parrot Tara has made some errors in the code, it's up to you to
        fix them! <br/> Click on Lesson 1 to get started!</h4>
          </div>
